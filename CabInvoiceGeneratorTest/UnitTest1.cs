...
namespace CabInvoiceGeneratorTest
{
    ...
    public class Tests
    {
        ...
        /// </summary>
        [Test]
        public void GivenDistanceAndTimeShouldReturnTotalFare()   //UC1
        {
...
*********************************************************************************************/
        ...
        {
            //Creating instance of InvoiceGenerator for Normal Ride
            invoiceGenerator = new InvoiceGenerator(RideType.NORMAL); // NORMAL
            Ride[] rides = { new Ride(2.0, 5), new Ride(0.1, 1) };

            //Ride[] rides = { new Ride(2.0, 5), new Ride(0.1, 5) }; //2.0 DISTANCE //5 TIME //0.1 DIS // 5 TIME
